	 	...
	 	<form:form method="POST" modelAttribute="book" class="form-horizontal">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="isbn"><spring:message code="label.book.isbn" /></label>
					<div class="col-md-7">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="name"><spring:message code="label.book.name" /></label>
					<div class="col-md-7">
						<c:choose>
							<c:when test="${edit}">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="year"><spring:message code="label.book.year" /></label>
					<div class="col-md-7">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="edition"><spring:message code="label.book.edition" /></label>
					<div class="col-md-7">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="summary"><spring:message code="label.book.summary" /></label>
					<div class="col-md-7">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="quantity"><spring:message code="label.book.quantity" /></label>
					<div class="col-md-7">
			...
			<div class="row">
				<div class="form-group col-md-12">
					<label class="col-md-3 control-lable" for="authors"><spring:message code="label.book.authors" /></label>
					<div class="col-md-7">

...
<div class="generic-container">
	...
	<div class="authbar">
		<span> <strong>${loggedinuser}</strong>, Seja Bem-Vindo.
		</span> <span class="floatRight"> <a href="<c:url value='/' />"><spring:message
					code="label.main" /></a><br /> <a href="<c:url value="/logout" />"><spring:message
					code="label.button.logout" /></a>
		</span>
	</div>
